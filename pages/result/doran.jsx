...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '김도란'이에요. 같이 플레이해볼래요? https://minigame.leaven.team";
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
              <img src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/549648e5-4433-43d4-58a6-fad2bbb25500/500x500" />
            </div>
          </div>
          <p className="text-5xl font-bold">김도란</p>
          <p className="text-xl mt-1 font-bold">
            원석대학교 해양생존탈출학과 숨죽이기전공 생존학석사
          </p>
          <p className="text-lg mt-3">ENFP | 농어촌 특별 장학생 | 서브래퍼</p>
        </div>
