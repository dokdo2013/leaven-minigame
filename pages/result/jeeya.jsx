...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '지야'에요. 같이 플레이해볼래요? https://leaven-minigame.vercel.app";

  return (
    <div>
      <Head>
        <title>지야 - 나와 가장 잘 맞는 레븐 멤버는?</title>
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 custom-image">
              <Image
                src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/08165e22-c9be-402c-a235-9e134830f800/500x500"
                alt="지야"
                layout="fill"
              />
            </div>
          </div>
          <p className="text-5xl font-bold">지야</p>
          <p className="text-xl mt-1 font-bold">
            원석대학교 영유아뒷바라지학과 곰세마리전공 분유조절학석사
          </p>
          <p className="text-lg mt-3">
            ISFJ | 전국 동요 콘테스트 1위 | 서브 보컬
          </p>
        </div>
