...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '아드리챔'이에요. 같이 플레이해볼래요? https://minigame.leaven.team";
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
              <img src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/4cc3e389-03c2-4b33-202d-600b216c2a00/500x500" />
            </div>
          </div>
