...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '아드리챔'이에요. 같이 플레이해볼래요? https://leaven-minigame.vercel.app";

  return (
    <div>
      <Head>
        <title>아드리챔 - 나와 가장 잘 맞는 레븐 멤버는?</title>
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 custom-image">
              <Image
                src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/4cc3e389-03c2-4b33-202d-600b216c2a00/500x500"
                alt="아드리챔"
                layout="fill"
              />
            </div>
          </div>
          <p className="text-5xl font-bold">아드리챔</p>
          <p className="text-xl mt-1 font-bold">
            원석대학교 츄르영양학과 참치츄르전공 츄르배합학석사
          </p>
          <p className="text-lg mt-3">
            ENFJ | LCK 광팬 (특히 T1), 리듬게임 좋아함 | 파파고
          </p>
        </div>
