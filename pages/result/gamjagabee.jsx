...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '감자가비'에요. 같이 플레이해볼래요? https://leaven-minigame.vercel.app";

  return (
    <div>
      <Head>
        <title>감자가비 - 나와 가장 잘 맞는 레븐 멤버는?</title>
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 custom-image">
              <Image
                src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/db1b9903-78a1-4fc2-d301-28da83542400/500x500"
                alt="감자가비"
                layout="fill"
              />
            </div>
          </div>
          <p className="text-5xl font-bold">감자가비</p>
          <p className="text-xl mt-1 font-bold">
            원석대학교 감자튀김연구학과 튀김전공 감자학석사
          </p>
          <p className="text-lg mt-3">
            INTP | 과대표, 임시 교수, 학교에 본인 소유의 감자밭 보유중 | 메인
            비주얼
          </p>
        </div>
