...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '유달린'이에요. 같이 플레이해볼래요? https://leaven-minigame.vercel.app";

  return (
    <div>
      <Head>
        <title>유달린 - 나와 가장 잘 맞는 레븐 멤버는?</title>
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 custom-image">
              <Image
                src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/a69b2748-81d5-434b-a747-c99c30752500/500x500"
                alt="유달린"
                layout="fill"
              />
            </div>
          </div>
          <p className="text-5xl font-bold">유달린</p>
          <p className="text-xl mt-1 font-bold">
            원석대학교 맵단진리학과 19금드립전공 쿨피스학학사 / 캡사이신학석사
          </p>
          <p className="text-lg mt-3">
            INTJ | 고학년이 되어도 매년, 매회 MT 한 번도 빠짐없이 참여, 교수님의
            친구, 먹부림과 술자리에 진심 | 입덕 요정, 대모님
          </p>
        </div>
