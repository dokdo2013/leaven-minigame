...
export default function Member() {
  ...
  return (
    <div>
      <Head>
        <title>포도당 - 나와 가장 잘 맞는 레븐 멤버는?</title>
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 custom-image">
              <Image
                src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/fa524576-4978-4d27-ac41-f619090f4500/500x500"
                alt="포도당"
                layout="fill"
              />
            </div>
          </div>
          <p className="text-5xl font-bold">포도당</p>
          <p className="text-xl mt-1 font-bold">
            원석대학교 관심통계학과 아이돌, 국악복수전공 아이돌 석사
          </p>
          <p className="text-lg mt-3">
            ENFP | 100만 틱톡커, 월클 아이돌 | 막내, 덕후몰이,{" "}
            <span className="line-through">스포요정</span>
          </p>
        </div>
