...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '김병살'이에요. 같이 플레이해볼래요? https://leaven-minigame.vercel.app";

  return (
    <div>
      <Head>
        <title>김병살 - 나와 가장 잘 맞는 레븐 멤버는?</title>
      ...
      <main>
        ...
        <div className="text-center my-10">
          ...
          <p className="text-xl mt-1 font-bold">
            원석대학교 씹덕행동심리연구학과 애니메이션전공 씹덕학석사
          </p>
          <p className="text-lg mt-3">
            INFP | 교내 멍때리기 대회 1등, 원석대 축제 코스프레대회 우수상 |
            비주얼 메인 래퍼
          </p>
        </div>
