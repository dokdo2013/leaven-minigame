...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '구슬요'에요. 같이 플레이해볼래요? https://minigame.leaven.team";
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
              <img src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/837e10f9-4f22-4e8f-2680-550471b1da00/500x500" />
            </div>
          </div>
