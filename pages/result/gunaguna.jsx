...
export default function Member() {
  const message =
    "나와 가장 잘 맞는 레븐 멤버는 '구나구나'에요. 같이 플레이해볼래요? https://leaven-minigame.vercel.app";

  return (
    <div>
      <Head>
        <title>구나구나 - 나와 가장 잘 맞는 레븐 멤버는?</title>
        ...
        <div className="text-center my-10">
          ...
          <div className="avatar">
            <div className="w-40 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 custom-image">
              <Image
                src="https://imagedelivery.net/lR-z0ff8FVe1ydEi9nc-5Q/e4bc8398-3eee-4850-9aa5-120560649100/500x500"
                alt="구나구나"
                layout="fill"
              />
            </div>
          </div>
          <p className="text-5xl font-bold">구나구나</p>
          <p className="text-xl mt-1 font-bold">
            원석대학교 팩폭어문학과 논리토론전공 팩트폭행학석사
          </p>
          <p className="text-lg mt-3">
            ENTP | 명문 재벌 가문 3세 | 메인 보컬, 감초
          </p>
        </div>
